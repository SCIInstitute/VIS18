...
function V =  resolveAmbiguityMidpointDecider(V, Img, k)
...
for i = 1:cellCount
        ...
        if (d1 < k) && (d3 < k)
         ...
         % get Sign at the Midpoint of a cell
        [signSaddleGTField, signMidpointGTField] = getGroundTruthSign(d00, d11, d01, d10, k);
        
        % Resolve topological ambiguity between 7 and 10 based on the sign of the saddle point
        % (midpoint decider) 
        if(signMidpointGTField == 1)
